...
## New Dependencies?
<!--
If you added a new dependency then please read https://github.com/Maxwbh/pdf-lib/blob/master/docs/CONTRIBUTING.md#adding-dependencies and then:
  ...
  * State how much it will increase @maxwbh/pdf-lib's bundle size.
...
## Checklist
- [ ] I read [CONTRIBUTING.md](https://github.com/Maxwbh/pdf-lib/blob/master/docs/CONTRIBUTING.md).
- [ ] I added/updated unit tests for my changes.
- [ ] I added/updated integration tests for my changes.
- [ ] I [ran the integration tests](https://github.com/Maxwbh/pdf-lib/blob/master/docs/CONTRIBUTING.md#running-the-integration-tests).
- [ ] I tested my changes in Node, Deno, and the browser.
- [ ] I viewed documents produced with my changes in Adobe Acrobat, Foxit Reader, Firefox, and Chrome.
- [ ] I added/updated doc comments for any new/modified public APIs.
- [ ] My changes work for both **new** and **existing** PDF files.
- [ ] I [ran the linter](https://github.com/Maxwbh/pdf-lib/blob/master/docs/CONTRIBUTING.md#running-the-linter) on my changes.
